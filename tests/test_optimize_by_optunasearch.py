...
lr_params = {"penalty": ["l2"], "C": [0.001, 100.0]}
rf_params = {"n_estimators": [50, 200], "max_depth": [10, 20]}
xgb_params = {
    "n_estimators": [50, 200],
    "max_depth": [10, 15],
    "learning_rate": [0.001, 0.1],
}
cb_params = {"iterations": [50, 200], "depth": [4, 8], "learning_rate": [0.001, 0.1]}
lgbm_params = {
    "n_estimators": [50, 200],
    "max_depth": [10, 20],
    "learning_rate": [0.001, 0.1],
}
brf_params = {"n_estimators": [50, 200], "max_depth": [10, 20]}
...
abc_params = {"n_estimators": [50, 200], "learning_rate": [0.001, 0.1]}
svc_params = {"C": [0.1, 10.0], "gamma": [0.001, 0.1]}
knn_params = {"n_neighbors": [3, 7], "weights": ["uniform", "distance"]}
dtc_params = {"criterion": ["gini", "entropy"], "max_depth": [5, 10]}
etc_params = {"n_estimators": [50, 200], "max_depth": [5, 10]}
...
rfr_params = {"n_estimators": [50, 200], "max_depth": [10, 20]}
gbr_params = {
    "n_estimators": [50, 200],
    "max_depth": [3, 10],
    "learning_rate": [0.01, 0.1],
}
etr_params = {"n_estimators": [50, 200], "max_depth": [10, 20]}
abr_params = {"n_estimators": [50, 200], "learning_rate": [0.01, 0.1]}
