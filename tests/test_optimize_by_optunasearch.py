...
@pytest.mark.parametrize('estimator, params', estimators_params_clf_optuna_search)
...
@pytest.mark.parametrize('estimator, params', estimators_params_reg_optuna_search)
